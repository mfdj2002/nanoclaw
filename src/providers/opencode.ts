...
registerProviderContainerConfig('opencode', (ctx) => {
  ...
  // Source provider/model/baseURL from .env (the launchd/systemd service env does
  // NOT load .env into process.env), falling back to the host process env. Mirrors
  // how claude.ts reads ANTHROPIC_BASE_URL. ANTHROPIC_BASE_URL is the OpenCode
  // baseURL for non-anthropic providers (e.g. DeepSeek) and must reach the container.
